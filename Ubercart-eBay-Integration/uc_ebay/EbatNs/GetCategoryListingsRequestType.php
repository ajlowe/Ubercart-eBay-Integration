 ...
 * specified sellers.<p>It is recommended that you consider using 
 * FindItemsAdvanced(in the Shopping API) instead of GetCategoryListings 
 * becauseFindItemsAdvanced is easier to use and faster.See <a 
