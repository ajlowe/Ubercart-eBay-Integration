 ...
 * listing durations.Each code in this code list specifies a number of days that a 
 * listing can beactive (i.e., available for bidding/buying). The validity of a 
 * codedepends on the listing type.Call GetCategoryFeatures to determine which 
 * listing formatssupport each duration for the site you are using. 
 *
